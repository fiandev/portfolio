  ...
  return (
    ...
    >
      <img
        ...
        alt={title ? title : Math.random() * 100}
      ...
      <div className="transition-all group-hover:rounded-md group-hover:shadow-md grid absolute place-items-center bottom-0 w-full h-32 hover:h-full bg-slate-50 bg-slate-50">
        <div className="group flex flex-col items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            <a
              href={link || "#"}
              className="flex gap-2 items-center transition-all duration-800 text-sm lg:text-md w-fit h-fit px-4 py-2 rounded-sm text-slate-50 bg-blue-400 outline outline-inherit hover:outline-blue-400 hover:outline-offset-2 hover:rounded-full"
            >
              <FontAwesomeIcon
