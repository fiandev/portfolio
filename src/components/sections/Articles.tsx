            ...
            <div className="grid gap-2.5 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                {articles
                    ...
                    articles.map((article) => {
                        ...
                        return (
                            <div className="flex flex-col gap-2 rounded-sm shadow-md dark:shadow-slate-900 h-64 md:h-72 lg:h-72 bg-slate-100/40 dark:bg-slate-800/40 backdrop-blur-sm">
                                <div style={{
                                ...
                                <div className="flex flex-col h-1/3 p-2">
                                    <Link target="_blank" href={`https://www.kompasiana.com/alfiansa/${article.prefix}/${article.slug}`} className="hover:underline font-semibold text-main text-sm md:text-lg lg:text-xl overflow-hidden h-2/3 text-ellipsis">
                                        {article.title}
                                    </Link>
