      ...
      <div className="group flex items-center justify-center lg:justify-between lg:px-8">
        <div className="w-fit h-fit relative">
          <Image
            ...
            } absolute inset-0 z-[2] w-48 h-48 shadow-md rounded-full border-2 border-sky-400`}
            alt="my avatar"
            srcset={data ? data.avatar.url : ""}
          />
        <Shapes className="absolute z-[1] max-w-48 max-h-48 lg:max-w-72 lg:max-h-72 lg:w-72 lg:h-72 p-4 relative bg-gradient-to-b from-sky-500 to-slate-100 border shadow-md p-8 overflow-hidden flex justify-center items-center"></Shapes>
        </div>
      </div>
