...
Easing.easeInBounce = function easeInBounce(
  ...
  return (
    amountOfChange -
    Easing.easeOutBounce(duration - elapsed, 0, amountOfChange, duration) +
    initialValue
  );
};
...
Easing.easeInOutBounce = function easeInOutBounce(
  ...
  if (elapsed < duration / 2) {
    return (
      Easing.easeInBounce(elapsed * 2, 0, amountOfChange, duration) * 0.5 +
      initialValue
    );
  }
  return (
    Easing.easeOutBounce(elapsed * 2 - duration, 0, amountOfChange, duration) *
      0.5 +
    amountOfChange * 0.5 +
    initialValue
  );
