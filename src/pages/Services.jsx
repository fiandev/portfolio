...
export default function Services() {
  return (
    <div className={`pt-8 scroll-smooth relative pt-2 dark:bg-slate-800`}>
      ...
      <Contact formClassName="outline-sky-100 hover:outline-main text-slate-100" className="bg-gradient-to-b from-sky-100 to-slate-50 dark:text-100 dark:from-main dark:to-slate-900" />
      <Footer />
    </div>
  );
}
