...
import { faGraduationCap, faCalendarDays, faCakeCandles, faLocationDot } from "@fortawesome/free-solid-svg-icons";
      ...
      <section id="about" className={ `bg-slate-50 dark:bg-slate-900 px-4 py-8 inset-x-0 transition-all duration-1000t flex flex-col gap-4 justify-start items-center lg:px-8` }>
        ...
        <div className="w-full h-fit grid px-auto md:grid-cols-2 gap-4 text-md">
          ...
          <div className="p-4 bg-blue-600 rounded-md">
            ...
            <ul className="flex flex-col items-start text-slate-100">
              <li className="flex gap-2 text-semibold items-center">
                ...
                <p>
                  SD Putra Indonesia <span className="text-bold text-slate-100">(2012 - 2018)</span>
                </p>
              </li>
              <li className="flex gap-2 text-semibold items-center">
                <FontAwesomeIcon icon={ faGraduationCap } />
                <p>
                  SMP Al-Amin Surabaya <span className="text-bold text-slate-100">(2018 - 2021)</span>
                </p>
              </li>
              <li className="flex gap-2 text-semibold items-center">
                <FontAwesomeIcon icon={ faGraduationCap } />
                <p>
                  SMK Abdurahman Wahid [computer and network engineer] <span className="text-bold text-slate-100">(2021 - 2024)</span>
                </p>
              </li>
            </ul>
          </div>
          ...
          <div className="p-4 bg-rose-600 rounded-md">
            <h1 className="text-bold text-slate-50 capitalize text-md md:text-lg lg:text-xl">biodata</h1>
            <ul className="flex flex-col items-start text-slate-100">
              <li className="flex gap-2 text-semibold items-center ">
                <FontAwesomeIcon icon={ faCalendarDays } />
                <p>
                  Birthdate: <span className="text-bold text-slate-100">13 June 2005</span>
                </p>
              </li>
              <li className="flex gap-2 text-semibold items-center ">
                <FontAwesomeIcon icon={ faCakeCandles } />
                <p>
                  Age: <span className="text-bold text-slate-100">{ age } Years Old</span>
                </p>
              </li>
              <li className="flex gap-2 text-semibold items-center ">
                <FontAwesomeIcon icon={ faLocationDot } />
                <p>
                  State: <span className="text-bold text-slate-100">Lamongan, East Java</span>
                </p>
              </li>
            </ul>
          </div>
