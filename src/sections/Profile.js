...
const Profile = ({ Data }) => {
  ...
  return (
    <section
      ...
      } bg-slate-50 dark:bg-slate-900 bg-fixed relative w-screen pt-20 h-screen md:min-h-screen flex flex-col gap-2 items-center lg:flex-row-reverse md:justify-center lg:px-24`}
    >
