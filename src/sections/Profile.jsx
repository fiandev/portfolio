  ...
  return (
    ...
    >
      ...
      <div className="relative w-full lg:w-90 flex flex-col items-center lg:items-start gap-2">
        <h1 className="text-shadow-md text-3xl capitalize font-bold font-mono bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-sky-600 text-center lg:text-start">
